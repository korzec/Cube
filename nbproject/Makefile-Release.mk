...
${TESTDIR}/tests/CompressorTestClass.o: tests/CompressorTestClass.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/CompressorTestClass.o tests/CompressorTestClass.cpp


${TESTDIR}/tests/CompressorTestRunner.o: tests/CompressorTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/CompressorTestRunner.o tests/CompressorTestRunner.cpp
