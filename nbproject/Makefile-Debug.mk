...
${OBJECTDIR}/encoder/parse_cmd.o: encoder/parse_cmd.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/encoder/parse_cmd.o encoder/parse_cmd.cpp
...
${OBJECTDIR}/cubecodec/BitStream.o: cubecodec/BitStream.cpp 
	${MKDIR} -p ${OBJECTDIR}/cubecodec
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/cubecodec/BitStream.o cubecodec/BitStream.cpp
...
${OBJECTDIR}/cubecodec/MQcoder.o: cubecodec/MQcoder.cpp 
	${MKDIR} -p ${OBJECTDIR}/cubecodec
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DDEBUG -MMD -MP -MF $@.d -o ${OBJECTDIR}/cubecodec/MQcoder.o cubecodec/MQcoder.cpp
...
${TESTDIR}/tests/CompressorTestClass.o: tests/CompressorTestClass.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DDEBUG -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/CompressorTestClass.o tests/CompressorTestClass.cpp


${TESTDIR}/tests/CompressorTestRunner.o: tests/CompressorTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DDEBUG -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/CompressorTestRunner.o tests/CompressorTestRunner.cpp


${TESTDIR}/tests/CubeIOTestClass.o: tests/CubeIOTestClass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DDEBUG -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/CubeIOTestClass.o tests/CubeIOTestClass.cpp


${TESTDIR}/tests/CubeIOTestRunner.o: tests/CubeIOTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DDEBUG -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/CubeIOTestRunner.o tests/CubeIOTestRunner.cpp


${TESTDIR}/tests/CompressorHuffmanTestClass.o: tests/CompressorHuffmanTestClass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DDEBUG -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/CompressorHuffmanTestClass.o tests/CompressorHuffmanTestClass.cpp


${TESTDIR}/tests/CompressorHuffmanTestRunner.o: tests/CompressorHuffmanTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DDEBUG -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/CompressorHuffmanTestRunner.o tests/CompressorHuffmanTestRunner.cpp


${TESTDIR}/tests/PictureTestClass.o: tests/PictureTestClass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DDEBUG -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/PictureTestClass.o tests/PictureTestClass.cpp


${TESTDIR}/tests/PictureTestRunner.o: tests/PictureTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DDEBUG -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/PictureTestRunner.o tests/PictureTestRunner.cpp
...
${OBJECTDIR}/encoder/parse_cmd_nomain.o: ${OBJECTDIR}/encoder/parse_cmd.o encoder/parse_cmd.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Wall -DDEBUG -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/encoder/parse_cmd_nomain.o encoder/parse_cmd.cpp;\
	else  \
...
${OBJECTDIR}/cubecodec/BitStream_nomain.o: ${OBJECTDIR}/cubecodec/BitStream.o cubecodec/BitStream.cpp 
	${MKDIR} -p ${OBJECTDIR}/cubecodec
	@NMOUTPUT=`${NM} ${OBJECTDIR}/cubecodec/BitStream.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Wall -DDEBUG -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/cubecodec/BitStream_nomain.o cubecodec/BitStream.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/cubecodec/BitStream.o ${OBJECTDIR}/cubecodec/BitStream_nomain.o;\
	fi
...
${OBJECTDIR}/cubecodec/MQcoder_nomain.o: ${OBJECTDIR}/cubecodec/MQcoder.o cubecodec/MQcoder.cpp 
	${MKDIR} -p ${OBJECTDIR}/cubecodec
	@NMOUTPUT=`${NM} ${OBJECTDIR}/cubecodec/MQcoder.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Wall -DDEBUG -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/cubecodec/MQcoder_nomain.o cubecodec/MQcoder.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/cubecodec/MQcoder.o ${OBJECTDIR}/cubecodec/MQcoder_nomain.o;\
	fi
